            ...
            <div className="md:w-1/2 bg-white rounded-md lg:w-[33vw] p-3 md:p-5 lg:p-10">
                ...
                <form className="flex flex-col items-center gap-6 p-4 lg:p-0" onSubmit={handleSubmit}>
                    <div className="flex flex-col justify-center">
                        ...
                        <input ref={emailRef} className={`input-login ${errors && errors.errors && errors.errors.email ? "input-error" : ""}`} type="text" name="email" id="email" placeholder="email@email.com" />
                        {errors && errors.errors ? errors.errors.email && <p className="px-2 py-1 text-xs text-black/80">{errors.errors.email[0]}</p> : ""}
                    </div>
                    <div className="flex flex-col justify-center">
                        <label className="text-lg" htmlFor="senha">Senha</label>
                        <input ref={senhaRef} className={`input-login ${errors && errors.errors && errors.errors.senha ? "input-error" : ""}`} type="password" name="senha" id="senha" placeholder="••••••••" />
                        {errors && errors.errors ? errors.errors.senha && <p className="px-2 py-1 text-xs text-black/80">{errors.errors.senha[0]}</p> : ""}
                    </div>
