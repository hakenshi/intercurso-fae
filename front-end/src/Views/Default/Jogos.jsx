...
import { faBasketball, faFutbol, faGlobe, faHandDots, faHeadset, faTableTennisPaddleBall, faVolleyball } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="w-full flex flex-col items-center">
            <div className="md:w-2/3 flex flex-col gap-3 p-5 justify-center items-center">
                <div className="flex w-full md:w-1/2 items-center justify-around gap-3 md:gap-0">
                    ...
                    <ButtonCategoria onClick={()=> setCategoira("6")} icon={faTableTennisPaddleBall} text={"Mesa"}/>
                </div>
            </div>
                ...
                <div className="p-5 flex gap-5 flex-wrap md:max-w-screen-xl">
                    {filteredJogos.map(({jogo, modalidade, placar, times})=>(
                        ...
                        key={jogo.id}>
                            {jogo.status === 1 ? (
                            <Card.Root>
                                <Card.TimeDefault modalidade={modalidade.nome} times={times} genero={modalidade.genero}/>
