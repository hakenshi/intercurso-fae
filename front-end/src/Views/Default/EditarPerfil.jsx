      ...
      <div className="flex items-center p-5 bg-gradient-to-tr from-unifae-green-4 via-unifae-green-2 via-60% to-unifae-green-3 w-full h-1/3 rounded-t-lg">
          <div className="flex justify-between gap-10 w-full">
            ...
            <div className="flex gap-5">
              ...
              <Link to={"/usuario/meu-perfil"}> <FontAwesomeIcon className='text-white text-xl' icon={faUser} /></Link>
              <Link to={"/usuario/configuracoes"}><FontAwesomeIcon className='text-white text-xl' icon={faCog} /></Link>
            </div>
          </div>
        </div>
        <div className="flex">
