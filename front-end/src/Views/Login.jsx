...
export default function Login(){
    return(
        <div className="bg-[#262626] w-screen h-screen flex justify-center items-center">
            <div className="w-[33vw] h-[55vh] bg-white rounded-md text-uni">
                ...
                <form className="flex flex-col items-center gap-6">
                    ...
                    <div className="flex flex-col">
                        <label className="text-start text-lg" htmlFor="email">Senha</label>
                    ...
                    <p>Ainda não tem conta? <span className="text-unifae-green-1 font-bold">Clique aqui</span></p>
                </form>
            </div>
        </div>
    )
